...
#ifndef HNC_ITERATOR_CONST_REVERSE_ITERATOR_HPP
#define HNC_ITERATOR_CONST_REVERSE_ITERATOR_HPP
...
{
	/**
	 * @brief Random const access reverse iterator
	 * 
	 * @code
	...
	public:
		 ...
		 * @param[in] i Index
		 */
		const_reverse_iterator(Container const & c, std::size_t const i = 0) :
			p_data(&c),
		...
		const_reverse_iterator() : p_data(nullptr), m_i(0) { }
